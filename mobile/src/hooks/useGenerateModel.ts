...
/**
 * Runs the reconstruction pipeline through whichever transport is active
 * (native bridge or HTTP dev wrapper) and exposes live progress.
 *
 * The underlying service reports progress via callbacks — this hook never
 * polls; it only re-renders when the callback fires.
 */
